...
We aim to organise Coding Clubs monthly, although sometimes our schedule may slip a little around holiday times. At first all sessions will be guided (_Guided Coding Club_, for details see schedule below), but as time goes by we will mix in some open (_Open Coding Club_) sessions.
...
| 3. Working with dates | 2026-03-03 | > [Reference sheet](reference/dates.md) <br/> > [Peng Ch. 11: Dates and Times](https://bookdown.org/rdpeng/rprogdatascience/dates-and-times.html) | > [Exercises 3](exercises/03-exercises-2025.md) <br/> > [Solutions 3](exercises/03-solutions-2025.R) |
| 4. Moving from R to Excel | 2026-04-01 | > [From spreadsheet thinking to R thinking](https://www.burns-stat.com/spreadsheet-r-vector/) <br/> > [Matt Parker on spreadsheets](https://www.youtube.com/watch?v=UBX2QQHlQ_I) | > Exercises 4 <br/> > Solutions 4 |
| **Hilary 2024** |
...
- **For new coders:**
  ...
  - [R Programming for Data Science](https://bookdown.org/rdpeng/rprogdatascience/): Not to be confused with similarly named resources!
